...
class HourlyShowDetailPagerAdapter(val hourlyList: List<Hourly>):RecyclerView.Adapter<HourlyShowDetailPagerAdapter.ItemHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        holder.binding.RVDetails.adapter = HourlyShowDetailAdapter(hourlyList[position])
    }
